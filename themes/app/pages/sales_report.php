...
<!--                --><?php //if ($lastReserve != $report['reserve_id']) {
                        ...
                        ?>
<!--                    <h3>ID da reserva: --><?php //= $lastReserve 
                                                ?><!--</h3>-->
<!--                    <h3>Total da reserva: --><?php //= $report['total_value'] 
                                                    ?><!--</h3>-->
<!--                --><?php //} 
                        ?>
<!---->
<!--                <div class="sales_data" style="border: black 1px solid; margin: 1px">-->
<!--                    <p>--><?php //= $report['product_name'] 
                                ?><!--</p>-->
<!--                    <p>Preço Un.: R$-->
<!--                        --><?php //= brl_price_format($report['value'] / $report['quantity']) 
                                ?><!--</p>-->
<!--                    <p>Quantidade: --><?php //= $report['quantity'] 
                                            ?><!--</p>-->
<!--                    <p>Total (preço x quantidade): --><?php //= $report['value'] 
                                                            ?><!--</p>-->
<!--                    <p>Reservado para:-->
<!--                        --><?php //= $search->selectFirst('user', 'WHERE user_id = :id', "id={$report['user_id']}", 'name')['name'] 
                                ?>
<!--                    </p>-->
<!--                    <p>Produto foi retirado? --><?php //= $report['redeemed'] == 1 ? 'Sim' : 'Não' 
                                                    ?><!--</p>-->
<!--                </div>-->
<!--            </div>-->
<!--        --><?php //} 
